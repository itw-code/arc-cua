"""Real Cortex LLM Client Adapter for Solari Hybrid CUA (Phase 5 Task 2).

Connects the Solari CUA orchestrator to real frontier or System-1 reasoning models
...
logger = logging.getLogger("solari_cua.cortex.real_llm")
...
class RealLlmCortex(CortexClient):
    ...
    def format_prompts(self, payload: EscalationPayload) -> Tuple[str, str]:
        ...
        system_prompt = (
            "You are the Solari CUA Cortex Reasoning Engine, an expert autonomous recovery agent.\n"
